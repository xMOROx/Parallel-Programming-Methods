...
CONFIGS = [
    [("CHUNK", 40000), ("BUCKETS_NUMBER", 2**12), ("CAPACITY_MULTIPLIER", 2.0)],
    [("CHUNK", 40000), ("BUCKETS_NUMBER", 2**13), ("CAPACITY_MULTIPLIER", 2.0)],
    [("CHUNK", 40000), ("BUCKETS_NUMBER", 2**14), ("CAPACITY_MULTIPLIER", 2.0)],
    [("CHUNK", 40000), ("BUCKETS_NUMBER", 2**15), ("CAPACITY_MULTIPLIER", 2.0)],
